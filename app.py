...
app.layout = html.Div(children=[
                dbc.Row([
                    dbc.Col([
                                        dbc.Card([
                                            html.H2("ASIMOV REPORT", style={"font-family": "Voltaire", "font-size": "30px"}),
                                            html.Hr(),
                                            html.P("Dashboard para análise de de vendas de supermercado."),

                                            html.H5("Cidades:", style={"color": "black"}),
                                            ...
                                            html.H5("Variável de análise", style={"color": "black", "margin-top": "30px"}),
...
def render_page_content(cities, main_variable):
    ...
    operation = np.sum if main_variable == "gross income" else np.sum
